# .NetCore使用ElasticSearch+NEST

**原文链接**: https://www.cnblogs.com/qiect/articles/16104412.html

**发布时间**: 2026-04-05 22:52
...
![ElasticSearch安装成功](/images/.NetCore使用ElasticSearch+NEST/16104412_1.png)
...
![EsClientProvider](/images/.NetCore使用ElasticSearch+NEST/16104412_2.png)

![IEsClientProvider](/images/.NetCore使用ElasticSearch+NEST/16104412_3.png)

3. 完成后就可以在Controller里注入了，如下图：

![Controller注入](/images/.NetCore使用ElasticSearch+NEST/16104412_4.png)
...
![GitHub下载](/images/.NetCore使用ElasticSearch+NEST/16104412_5.png)
...
![npm运行成功](/images/.NetCore使用ElasticSearch+NEST/16104412_6.png)

也可以访问 http://localhost:9100/，跟我下面的图内容差不多也说明成功了

![Head工具界面](/images/.NetCore使用ElasticSearch+NEST/16104412_7.png)
